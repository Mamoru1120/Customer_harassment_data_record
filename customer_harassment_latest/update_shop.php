...
$sql = "UPDATE shop_an_table SET name_of_shop=:name_of_shop,prefecture=:prefecture,name_of_delegate=:name_of_delegate,mail=:mail,phone=:phone WHERE shop_id=:shop_id";
