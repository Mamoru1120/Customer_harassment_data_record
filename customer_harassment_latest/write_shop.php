...
$sql = "INSERT INTO shop_an_table(name_of_shop,prefecture,name_of_delegate,mail,phone,lid,lpw,user_type,status,recorded_date)VALUES(:name_of_shop,:prefecture,:name_of_delegate,:mail,:phone,:lid,:lpw,:user_type,:status,sysdate())";
